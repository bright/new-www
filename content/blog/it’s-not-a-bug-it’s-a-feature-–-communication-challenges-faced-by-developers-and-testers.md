...
During my career, I've been several times in a situation, where despite my huge effort and certainty, the issue I raised has been marked as non-bug. I’ve presented the requirements from the feature ticket, I’ve pointed out an inconsistency in the software, I’ve explained why the given behavior of the app might be confusing to users, and all of this went for nothing. It was just moved to “Won’t do”, the tend of the story. The only comment on that is if you ever face a similar situation, you should keep in your head that you did your best and you can’t fix everything.
