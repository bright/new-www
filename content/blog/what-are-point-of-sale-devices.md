...
<div class='block-button'><h2>Working on ePOS app?</h2><div>If you are a startup owner and look for a software agency, let us know more about your project. Hardware is only part of success in retail. The key is to connect it with the custom-developed ePOS Android and iOS applications. And that is our specialty.</div><a href="/start-prpje"><button>Let's talk about your ePOS app</button></a></div>