...
There’s no clear-cut answer to this question – any additional script has the potential to impact your website or web [app’s performance](/blog/healthcare-app-performance-monitoring/). The best way to know the actual effect is to **measure your performance metrics before and after implementing the Clarity script**.

A particularly important consideration is using **Clarity in mobile applications**. Based on our experience, **the impact can vary**. In some projects, we observed performance issues – especially on older mobile devices – while in others, there were no complaints or signs of degradation. That’s why it's essential to follow a test-and-measure approach.
