...
layout: post
image: /images/jetbrains-exposed-logo.png
hidden: false
comments: true
published: true
---
...
should respond with a list of three persons: `John`, `George`, and `Megan`. Those will be represented by the _header_ only (meaning, there will be no information about addresses yet)\
