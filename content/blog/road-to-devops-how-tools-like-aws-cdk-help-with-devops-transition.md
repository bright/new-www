...
Now, let's pay a visit to Dr Emmett Lathrop Brown, and get use of that fancy DeLorean DMC-12 to jump into the past for a second. Someone is weaving at us! That's a younger version of me. Meet Michał, **the SysOps.** He is Working in a big corporation with bare metal servers and some virtualisation in place. Oh, and he has keys to datacenter! And a winter wool hat for hours spent there with all the fans and air conditioning on.
