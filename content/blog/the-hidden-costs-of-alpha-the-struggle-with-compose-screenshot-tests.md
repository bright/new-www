...
```
java.lang.NullPointerException: getValue(...) must not be null at com.android.compose.screenshot.PreviewScreenshotGradlePlugin$Companion.getSCREENSHOT_TEST_PLUGIN_VERSION(PreviewScreenshotGradlePlugin.kt:95)
```
...
We added tests, generated reference images and verified everything locally. It worked perfectly—valid UI changes passed, and regressions triggered failures.
