...
excerpt: How to make iOS Simulator work with Right-To-Left languages when it's
  started from AppCode?
...
<br/><br/>
![AppCode RTL Config](../../static/images/appcode-rtl-config.png "AppCode RTL Configuration")
<br/><br/>
