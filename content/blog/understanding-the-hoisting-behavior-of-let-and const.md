...
Within JavaScript, in tandem with variable hoisting, an auxiliary mechanism comes into play when a variable is declared using **var**. This mechanism, in adherence to hoisting principles, **initializes** the variable with an **undefined** value \[2]:
