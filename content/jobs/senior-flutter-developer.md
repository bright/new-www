...
**This hiring process is for future Flutter openings that will be available in the coming months.**
...
👉 strong practical experience with Flutter and Dart

👉 experience with at least one native mobile technology (Kotlin/Swift)

👉 proficiency with state management patterns in Flutter (preferably BLoC)

👉 experience with Flutter libraries such as Flutter Bloc, Bloc, Dartz, RxDart, Dio, Retrofit, and injectable (or equivalent alternatives)

👉 understanding of asynchronous programming and concurrency in mobile applications
...
👉 familiarity with app publishing processes on both App Store and Google Play
