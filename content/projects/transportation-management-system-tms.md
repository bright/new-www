...
**Our team managed to meet the crucial client’s requirement** – delivering a fast transport listings filtering system. As a result, **the system quickly analyses routes for forwarders in just 3-5 seconds per order, saving a total of 300 h per employee and year**. Before that, the filtering process had to be done manually.
