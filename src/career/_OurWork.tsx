...
const OurWork: React.FC = () => {
  const quotes = [
      {
      avatar_hover: (
        <StaticImage src='../../static/images/patryks_passion_team.png' alt='Patryk' className='quote-img' />
      ),
      short_name: 'Patryk',
      bio: 'Senior Backend Developer',
      slug: 'patryk-s',
      quote:
        `People here are kind and positive, and that's the most important thing.`,
    },
    {
      avatar_hover: (
        <StaticImage src='../../static/images/pawel_passion_team.png' alt='Paweł' className='quote-img' />
      ),
      short_name: 'Paweł',
      bio: 'Fullstack Developer',
      slug: 'pawel-o',
      quote:
        `The projects are interesting, and I really appreciate the work culture and the openness to feedback.`,
    },
    {
      avatar_hover: (
    ...
    },
    {
      ...
      slug: 'michal-d',
      quote:
        `For a long time, I thought I couldn't possibly meet the requirements to join Bright Inventions. Obviously, I now regret that hesitation because I really enjoy working here.`,
    },
    {
      avatar_hover: (
