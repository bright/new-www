  ...
  return (
    ...
    faqs && <CustomSection paddingProps='0rem 15rem 2rem 15rem' paddingMobileProps='0 1.125rem 0'>
      <CustomSectionInner>
        ...
        <FaqsDropdown faqs={faqs} faqSlug={faqSlug} slug={routeLinks.career()} generateLink={(args) => routeLinks.career({ faqSlug: args.faqSlug })} ref={myRef} offset={100} shortList={true} />
      </CustomSectionInner>
    </CustomSection>
  )
}
