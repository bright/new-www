...
![](/images/host-website-with-aws-s3/www.png)
...
![](/images/host-website-with-aws-s3/create_bucket.png)
...
![](/images/host-website-with-aws-s3/bucket_name.png)
...
![](/images/host-website-with-aws-s3/permissions.png)

**3. Enable static website hosting**

Select the `Properties` tab and the `Static website hosting` box.

![](/images/host-website-with-aws-s3/properties.png)
...
![](/images/host-website-with-aws-s3/.png)
...
![](/images/host-website-with-aws-s3/404.png)
...
![](/images/host-website-with-aws-s3/error.png)
