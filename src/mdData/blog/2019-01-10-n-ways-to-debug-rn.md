...
![](/images/n-ways-to-debug-rn/image1.jpeg)
...
![](/images/n-ways-to-debug-rn/1-add-config.png)

![](/images/n-ways-to-debug-rn/2-edit-config.png)

Add a new `React Native` configuration. 

![](/images/n-ways-to-debug-rn/3-config-rn.png)
...
![](/images/n-ways-to-debug-rn/4-ios-config.png)
...
![](/images/n-ways-to-debug-rn/5-android-config.png)
...
![](/images/n-ways-to-debug-rn/6-in-app.png)
