      ...
      <div className='container'>
        <form className='section' data-form-type='job' onSubmit={onFormSubmit}>
          ...
          <div className='field'>
            ...
            />
            {success && <p className='help is-success'>Thank you! Your submission has been received!</p>}
            {error && <p className='help is-danger'>Oops! Something went wrong while submitting the form.</p>}
          </div>
