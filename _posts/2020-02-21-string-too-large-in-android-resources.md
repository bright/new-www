...
comments: true
hidden: true
tags: ['android', 'large', 'string', 'aapt', 'apk', 'crash']
---
...
Would you guess how did that happen?
...
_I recommend generating such a long string using some kind of [lorem ipsum generator](https://www.lipsum.com/) rather than writing it yourself 8-)_

But if you want to crash your app in a way I mentioned above, it will be a little more complex. You still have to add a string that large but this time try to put it into the [vector drawable](2017-10-19-creating-simple-vector-drawables-in-android-studio.md) `android:pathData` attribute.

_Having vector drawables with very long paths is not recommended and Android Studio or lint should warn you about it, but there is no warning when you exceed the abovementioned limit in a string resource._
...
_The bungee photo used in this post was published by Jeffrey Grospe on Unsplash. Thank you!_
